...
// Attached to the main export is a `main` method which returns a Complex128Array...
{
	...
	zswap.main( zx.length, zx, 1, zy, 1 ); // $ExpectType Complex128Array
}
...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	zswap.main( '10', zx, 1, zy, 1 ); // $ExpectError
	zswap.main( true, zx, 1, zy, 1 ); // $ExpectError
	zswap.main( false, zx, 1, zy, 1 ); // $ExpectError
	zswap.main( null, zx, 1, zy, 1 ); // $ExpectError
	zswap.main( undefined, zx, 1, zy, 1 ); // $ExpectError
	zswap.main( [], zx, 1, zy, 1 ); // $ExpectError
	zswap.main( {}, zx, 1, zy, 1 ); // $ExpectError
	zswap.main( ( x: number ): number => x, zx, 1, zy, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a second argument which is not a Complex128Array...
{
	...
	zswap.main( zx.length, 10, 1, zy, 1 ); // $ExpectError
	zswap.main( zx.length, '10', 1, zy, 1 ); // $ExpectError
	zswap.main( zx.length, true, 1, zy, 1 ); // $ExpectError
	zswap.main( zx.length, false, 1, zy, 1 ); // $ExpectError
	zswap.main( zx.length, null, 1, zy, 1 ); // $ExpectError
	zswap.main( zx.length, undefined, 1, zy, 1 ); // $ExpectError
	zswap.main( zx.length, [], 1, zy, 1 ); // $ExpectError
	zswap.main( zx.length, {}, 1, zy, 1 ); // $ExpectError
	zswap.main( zx.length, ( x: number ): number => x, 1, zy, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a third argument which is not a number...
{
	...
	zswap.main( zx.length, zx, '10', zy, 1 ); // $ExpectError
	zswap.main( zx.length, zx, true, zy, 1 ); // $ExpectError
	zswap.main( zx.length, zx, false, zy, 1 ); // $ExpectError
	zswap.main( zx.length, zx, null, zy, 1 ); // $ExpectError
	zswap.main( zx.length, zx, undefined, zy, 1 ); // $ExpectError
	zswap.main( zx.length, zx, [], zy, 1 ); // $ExpectError
	zswap.main( zx.length, zx, {}, zy, 1 ); // $ExpectError
	zswap.main( zx.length, zx, ( x: number ): number => x, zy, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fourth argument which is not a Complex128Array...
{
	...
	zswap.main( zx.length, zx, 1, 10, 1 ); // $ExpectError
	zswap.main( zx.length, zx, 1, '10', 1 ); // $ExpectError
	zswap.main( zx.length, zx, 1, true, 1 ); // $ExpectError
	zswap.main( zx.length, zx, 1, false, 1 ); // $ExpectError
	zswap.main( zx.length, zx, 1, null, 1 ); // $ExpectError
	zswap.main( zx.length, zx, 1, undefined, 1 ); // $ExpectError
	zswap.main( zx.length, zx, 1, [], 1 ); // $ExpectError
	zswap.main( zx.length, zx, 1, {}, 1 ); // $ExpectError
	zswap.main( zx.length, zx, 1, ( x: number ): number => x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fifth argument which is not a number...
{
	...
	zswap.main( zx.length, zx, 1, zy, '10' ); // $ExpectError
	zswap.main( zx.length, zx, 1, zy, true ); // $ExpectError
	zswap.main( zx.length, zx, 1, zy, false ); // $ExpectError
	zswap.main( zx.length, zx, 1, zy, null ); // $ExpectError
	zswap.main( zx.length, zx, 1, zy, undefined ); // $ExpectError
	zswap.main( zx.length, zx, 1, zy, [] ); // $ExpectError
	zswap.main( zx.length, zx, 1, zy, {} ); // $ExpectError
	zswap.main( zx.length, zx, 1, zy, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided an unsupported number of arguments...
{
	...
	zswap.main(); // $ExpectError
	zswap.main( zx.length ); // $ExpectError
	zswap.main( zx.length, zx ); // $ExpectError
	zswap.main( zx.length, zx, 1 ); // $ExpectError
	zswap.main( zx.length, zx, 1, zy ); // $ExpectError
	zswap.main( zx.length, zx, 1, zy, 1, 10 ); // $ExpectError
}
...
// Attached to main export is an `ndarray` method which returns a Complex128Array...
{
	...
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, 0 ); // $ExpectType Complex128Array
}
...
// The compiler throws an error if the `ndarray` method is provided a first argument which is not a number...
{
	...
	zswap.ndarray( '10', zx, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( true, zx, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( false, zx, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( null, zx, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( undefined, zx, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( [], zx, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( {}, zx, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( ( x: number ): number => x, zx, 1, 0, zy, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a second argument which is not a Complex128Array...
{
	...
	zswap.ndarray( zx.length, 10, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, '10', 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, true, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, false, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, null, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, undefined, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, [], 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, {}, 1, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, ( x: number ): number => x, 1, 0, zy, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a third argument which is not a number...
{
	...
	zswap.ndarray( zx.length, zx, '10', 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, true, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, false, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, null, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, undefined, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, [], 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, {}, 0, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, ( x: number ): number => x, 0, zy, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a fourth argument which is not a number...
{
	...
	zswap.ndarray( zx.length, zx, 1, '10', zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, true, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, false, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, null, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, undefined, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, [], zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, {}, zy, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, ( x: number ): number => x, zy, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a fifth argument which is not a Complex128Array...
{
	...
	zswap.ndarray( zx.length, zx, 1, 0, 10, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, '10', 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, true, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, false, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, null, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, undefined, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, [], 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, {}, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, ( x: number ): number => x, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a sixth argument which is not a number...
{
	...
	zswap.ndarray( zx.length, zx, 1, 0, zy, '10', 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, true, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, false, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, null, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, undefined, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, [], 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, {}, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, ( x: number ): number => x, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a seventh argument which is not a number...
{
	...
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, '10' ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, true ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, false ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, null ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, undefined ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, [] ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, {} ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided an unsupported number of arguments...
{
	...
	zswap.ndarray( zx.length ); // $ExpectError
	zswap.ndarray( zx.length, zx ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1 ); // $ExpectError
	zswap.ndarray( zx.length, zx, 1, 0, zy, 1, 0, 10 ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	zswap.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	zswap.Module( '10' ); // $ExpectError
	zswap.Module( true ); // $ExpectError
	zswap.Module( false ); // $ExpectError
	zswap.Module( null ); // $ExpectError
	zswap.Module( undefined ); // $ExpectError
	zswap.Module( [] ); // $ExpectError
	zswap.Module( {} ); // $ExpectError
	zswap.Module( ( x: number ): number => x ); // $ExpectError
}
